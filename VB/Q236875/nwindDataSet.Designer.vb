...
Namespace Q236875
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal CategoryID As Integer) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, CategoryID}
	...
	End Class
End Namespace
Namespace Q236875.nwindDataSetTableAdapters
